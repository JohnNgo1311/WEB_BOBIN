    ...
    try {
        ...
        let reviewHTML = `
            <ul style="list-style: none; padding: 12px; background: #f9fafb; border-radius: 6px; text-align: left; border: 1px solid #e5e7eb;">
                ...
                <li style="margin-bottom: 8px; border-bottom: 1px dashed #ccc; padding-bottom: 4px; display: flex; justify-content: space-between;"><strong>Sản phẩm:</strong> <span style="color: #0056b3;">${productCode} (${orderCode})</span></li>
